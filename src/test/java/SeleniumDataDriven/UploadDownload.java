...
public class UploadDownload {
	public static void main(String[] args) throws IOException {
		...
		String updatedValue = "512";
		String fileName = "C:\\Users\\pranavsitoke\\Downloads\\download.xlsx";
 ...
 java.util.Iterator<Row> rows= sheet.iterator(); 
	...
	while(rows.hasNext()) {
		...
		{								
			...
			if(cell.getCellTypeEnum()== CellType.STRING &&  cell.getStringCellValue().equalsIgnoreCase(text))				
			{					
				rowIndex=k;
			}
		}
	...
	ce=firstrow.cellIterator();//row is collection of cells 
	int k=1; 
	int coloumn = 0; 
	while(ce.hasNext()) 
	{ 
